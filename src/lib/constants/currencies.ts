...
/**
 * Global ISO 4217 currency list used across the product (job forms,
 * compensation, billing). Popular currencies are intentionally placed first so
 * they surface at the top of pickers; the rest are alphabetised by code.
 */
...
/** Option shape ready for AppSelect / pickers, e.g. "USD — US Dollar ($)". */
