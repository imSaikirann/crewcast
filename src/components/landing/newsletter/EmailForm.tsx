...
export function EmailForm({ size = "md", className = "", buttonLabel = "Get started" }: EmailFormProps) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className={`font-sora group inline-flex shrink-0 items-center justify-center gap-2 self-center rounded-full bg-neutral-900 font-medium text-white shadow-sm ring-1 ring-neutral-900/10 transition-all duration-200 hover:-translate-y-0.5 hover:bg-neutral-800 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900 focus-visible:ring-offset-2 active:translate-y-0 sm:self-auto ${
