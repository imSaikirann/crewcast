...
export const ApplicationFindManySelectSchema: z.ZodType<Prisma.ApplicationSelect> = z.object({
...
export const ApplicationFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    jobId: z.boolean().optional(),
    job: z.boolean().optional(),
    fullName: z.boolean().optional(),
...
export const ApplicationFindManySchema: z.ZodType<Prisma.ApplicationFindManyArgs> = z.object({ select: ApplicationFindManySelectSchema.optional(), include: z.lazy(() => ApplicationIncludeObjectSchema.optional()), orderBy: z.union([ApplicationOrderByWithRelationInputObjectSchema, ApplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ApplicationWhereInputObjectSchema.optional(), cursor: ApplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ApplicationScalarFieldEnumSchema, ApplicationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ApplicationFindManyArgs>;

export const ApplicationFindManyZodSchema = z.object({ select: ApplicationFindManySelectSchema.optional(), include: z.lazy(() => ApplicationIncludeObjectSchema.optional()), orderBy: z.union([ApplicationOrderByWithRelationInputObjectSchema, ApplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ApplicationWhereInputObjectSchema.optional(), cursor: ApplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ApplicationScalarFieldEnumSchema, ApplicationScalarFieldEnumSchema.array()]).optional() }).strict();