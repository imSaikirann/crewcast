...
export const FormFieldFindManySelectSchema: z.ZodType<Prisma.FormFieldSelect> = z.object({
...
export const FormFieldFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    roleId: z.boolean().optional(),
    role: z.boolean().optional(),
    label: z.boolean().optional(),
...
export const FormFieldFindManySchema: z.ZodType<Prisma.FormFieldFindManyArgs> = z.object({ select: FormFieldFindManySelectSchema.optional(), include: z.lazy(() => FormFieldIncludeObjectSchema.optional()), orderBy: z.union([FormFieldOrderByWithRelationInputObjectSchema, FormFieldOrderByWithRelationInputObjectSchema.array()]).optional(), where: FormFieldWhereInputObjectSchema.optional(), cursor: FormFieldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FormFieldScalarFieldEnumSchema, FormFieldScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FormFieldFindManyArgs>;

export const FormFieldFindManyZodSchema = z.object({ select: FormFieldFindManySelectSchema.optional(), include: z.lazy(() => FormFieldIncludeObjectSchema.optional()), orderBy: z.union([FormFieldOrderByWithRelationInputObjectSchema, FormFieldOrderByWithRelationInputObjectSchema.array()]).optional(), where: FormFieldWhereInputObjectSchema.optional(), cursor: FormFieldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FormFieldScalarFieldEnumSchema, FormFieldScalarFieldEnumSchema.array()]).optional() }).strict();