...
export const RecruiterFindManySelectSchema: z.ZodType<Prisma.RecruiterSelect> = z.object({
...
export const RecruiterFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    companyName: z.boolean().optional(),
