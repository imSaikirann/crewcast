...
export const FormFieldFindFirstSelectSchema: z.ZodType<Prisma.FormFieldSelect> = z.object({
...
export const FormFieldFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    roleId: z.boolean().optional(),
    role: z.boolean().optional(),
    label: z.boolean().optional(),
...
export const FormFieldFindFirstSchema: z.ZodType<Prisma.FormFieldFindFirstArgs> = z.object({ select: FormFieldFindFirstSelectSchema.optional(), include: z.lazy(() => FormFieldIncludeObjectSchema.optional()), orderBy: z.union([FormFieldOrderByWithRelationInputObjectSchema, FormFieldOrderByWithRelationInputObjectSchema.array()]).optional(), where: FormFieldWhereInputObjectSchema.optional(), cursor: FormFieldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FormFieldScalarFieldEnumSchema, FormFieldScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FormFieldFindFirstArgs>;

export const FormFieldFindFirstZodSchema = z.object({ select: FormFieldFindFirstSelectSchema.optional(), include: z.lazy(() => FormFieldIncludeObjectSchema.optional()), orderBy: z.union([FormFieldOrderByWithRelationInputObjectSchema, FormFieldOrderByWithRelationInputObjectSchema.array()]).optional(), where: FormFieldWhereInputObjectSchema.optional(), cursor: FormFieldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FormFieldScalarFieldEnumSchema, FormFieldScalarFieldEnumSchema.array()]).optional() }).strict();