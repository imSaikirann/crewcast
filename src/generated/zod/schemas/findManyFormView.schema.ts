...
export const FormViewFindManySelectSchema: z.ZodType<Prisma.FormViewSelect> = z.object({
...
export const FormViewFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    formId: z.boolean().optional(),
    form: z.boolean().optional(),
    ip: z.boolean().optional(),
...
export const FormViewFindManySchema: z.ZodType<Prisma.FormViewFindManyArgs> = z.object({ select: FormViewFindManySelectSchema.optional(), include: z.lazy(() => FormViewIncludeObjectSchema.optional()), orderBy: z.union([FormViewOrderByWithRelationInputObjectSchema, FormViewOrderByWithRelationInputObjectSchema.array()]).optional(), where: FormViewWhereInputObjectSchema.optional(), cursor: FormViewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FormViewScalarFieldEnumSchema, FormViewScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FormViewFindManyArgs>;

export const FormViewFindManyZodSchema = z.object({ select: FormViewFindManySelectSchema.optional(), include: z.lazy(() => FormViewIncludeObjectSchema.optional()), orderBy: z.union([FormViewOrderByWithRelationInputObjectSchema, FormViewOrderByWithRelationInputObjectSchema.array()]).optional(), where: FormViewWhereInputObjectSchema.optional(), cursor: FormViewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FormViewScalarFieldEnumSchema, FormViewScalarFieldEnumSchema.array()]).optional() }).strict();