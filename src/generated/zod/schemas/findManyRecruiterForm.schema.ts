...
export const RecruiterFormFindManySelectSchema: z.ZodType<Prisma.RecruiterFormSelect> = z.object({
...
export const RecruiterFormFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    recruiterId: z.boolean().optional(),
    recruiter: z.boolean().optional(),
    domainId: z.boolean().optional(),
...
export const RecruiterFormFindManySchema: z.ZodType<Prisma.RecruiterFormFindManyArgs> = z.object({ select: RecruiterFormFindManySelectSchema.optional(), include: z.lazy(() => RecruiterFormIncludeObjectSchema.optional()), orderBy: z.union([RecruiterFormOrderByWithRelationInputObjectSchema, RecruiterFormOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecruiterFormWhereInputObjectSchema.optional(), cursor: RecruiterFormWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecruiterFormScalarFieldEnumSchema, RecruiterFormScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RecruiterFormFindManyArgs>;

export const RecruiterFormFindManyZodSchema = z.object({ select: RecruiterFormFindManySelectSchema.optional(), include: z.lazy(() => RecruiterFormIncludeObjectSchema.optional()), orderBy: z.union([RecruiterFormOrderByWithRelationInputObjectSchema, RecruiterFormOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecruiterFormWhereInputObjectSchema.optional(), cursor: RecruiterFormWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecruiterFormScalarFieldEnumSchema, RecruiterFormScalarFieldEnumSchema.array()]).optional() }).strict();