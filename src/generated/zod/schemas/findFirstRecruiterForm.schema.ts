...
export const RecruiterFormFindFirstSelectSchema: z.ZodType<Prisma.RecruiterFormSelect> = z.object({
...
export const RecruiterFormFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    recruiterId: z.boolean().optional(),
    recruiter: z.boolean().optional(),
    domainId: z.boolean().optional(),
...
export const RecruiterFormFindFirstSchema: z.ZodType<Prisma.RecruiterFormFindFirstArgs> = z.object({ select: RecruiterFormFindFirstSelectSchema.optional(), include: z.lazy(() => RecruiterFormIncludeObjectSchema.optional()), orderBy: z.union([RecruiterFormOrderByWithRelationInputObjectSchema, RecruiterFormOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecruiterFormWhereInputObjectSchema.optional(), cursor: RecruiterFormWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecruiterFormScalarFieldEnumSchema, RecruiterFormScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RecruiterFormFindFirstArgs>;

export const RecruiterFormFindFirstZodSchema = z.object({ select: RecruiterFormFindFirstSelectSchema.optional(), include: z.lazy(() => RecruiterFormIncludeObjectSchema.optional()), orderBy: z.union([RecruiterFormOrderByWithRelationInputObjectSchema, RecruiterFormOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecruiterFormWhereInputObjectSchema.optional(), cursor: RecruiterFormWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecruiterFormScalarFieldEnumSchema, RecruiterFormScalarFieldEnumSchema.array()]).optional() }).strict();