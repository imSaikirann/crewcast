...
export const JobReportFindManySelectSchema: z.ZodType<Prisma.JobReportSelect> = z.object({
...
export const JobReportFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    formId: z.boolean().optional(),
    form: z.boolean().optional(),
    reason: z.boolean().optional(),
