...
import { ApplicationUncheckedUpdateManyWithoutJobNestedInputObjectSchema as ApplicationUncheckedUpdateManyWithoutJobNestedInputObjectSchema } from './ApplicationUncheckedUpdateManyWithoutJobNestedInput.schema';
import { FormViewUncheckedUpdateManyWithoutFormNestedInputObjectSchema as FormViewUncheckedUpdateManyWithoutFormNestedInputObjectSchema } from './FormViewUncheckedUpdateManyWithoutFormNestedInput.schema';
import { JobReportUncheckedUpdateManyWithoutFormNestedInputObjectSchema as JobReportUncheckedUpdateManyWithoutFormNestedInputObjectSchema } from './JobReportUncheckedUpdateManyWithoutFormNestedInput.schema'

import { JsonValueSchema as jsonSchema } from '../../helpers/json-helpers';

const makeSchema = () => z.object({
  domainId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  ...
  applications: z.lazy(() => ApplicationUncheckedUpdateManyWithoutJobNestedInputObjectSchema).optional(),
  views: z.lazy(() => FormViewUncheckedUpdateManyWithoutFormNestedInputObjectSchema).optional(),
  jobReport: z.lazy(() => JobReportUncheckedUpdateManyWithoutFormNestedInputObjectSchema).optional()
}).strict();
export const RecruiterFormUncheckedUpdateWithoutRecruiterInputObjectSchema: z.ZodType<Prisma.RecruiterFormUncheckedUpdateWithoutRecruiterInput> = makeSchema() as unknown as z.ZodType<Prisma.RecruiterFormUncheckedUpdateWithoutRecruiterInput>;
export const RecruiterFormUncheckedUpdateWithoutRecruiterInputObjectZodSchema = makeSchema();
