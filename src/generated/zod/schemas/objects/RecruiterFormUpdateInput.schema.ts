...
import { RecruiterUpdateOneRequiredWithoutRecruiterFormsNestedInputObjectSchema as RecruiterUpdateOneRequiredWithoutRecruiterFormsNestedInputObjectSchema } from './RecruiterUpdateOneRequiredWithoutRecruiterFormsNestedInput.schema';
...
import { ApplicationUpdateManyWithoutJobNestedInputObjectSchema as ApplicationUpdateManyWithoutJobNestedInputObjectSchema } from './ApplicationUpdateManyWithoutJobNestedInput.schema';
import { FormViewUpdateManyWithoutFormNestedInputObjectSchema as FormViewUpdateManyWithoutFormNestedInputObjectSchema } from './FormViewUpdateManyWithoutFormNestedInput.schema';
import { JobReportUpdateManyWithoutFormNestedInputObjectSchema as JobReportUpdateManyWithoutFormNestedInputObjectSchema } from './JobReportUpdateManyWithoutFormNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  recruiter: z.lazy(() => RecruiterUpdateOneRequiredWithoutRecruiterFormsNestedInputObjectSchema).optional(),
  domain: z.lazy(() => DomainsUpdateOneRequiredWithoutRecruiterFormsNestedInputObjectSchema).optional(),
  applications: z.lazy(() => ApplicationUpdateManyWithoutJobNestedInputObjectSchema).optional(),
  views: z.lazy(() => FormViewUpdateManyWithoutFormNestedInputObjectSchema).optional(),
  jobReport: z.lazy(() => JobReportUpdateManyWithoutFormNestedInputObjectSchema).optional()
}).strict();
export const RecruiterFormUpdateInputObjectSchema: z.ZodType<Prisma.RecruiterFormUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.RecruiterFormUpdateInput>;
export const RecruiterFormUpdateInputObjectZodSchema = makeSchema();
