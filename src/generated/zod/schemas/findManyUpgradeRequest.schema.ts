...
export const UpgradeRequestFindManySelectSchema: z.ZodType<Prisma.UpgradeRequestSelect> = z.object({
...
export const UpgradeRequestFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    email: z.boolean().optional(),
    company: z.boolean().optional(),
...
export const UpgradeRequestFindManySchema: z.ZodType<Prisma.UpgradeRequestFindManyArgs> = z.object({ select: UpgradeRequestFindManySelectSchema.optional(),  orderBy: z.union([UpgradeRequestOrderByWithRelationInputObjectSchema, UpgradeRequestOrderByWithRelationInputObjectSchema.array()]).optional(), where: UpgradeRequestWhereInputObjectSchema.optional(), cursor: UpgradeRequestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UpgradeRequestScalarFieldEnumSchema, UpgradeRequestScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UpgradeRequestFindManyArgs>;

export const UpgradeRequestFindManyZodSchema = z.object({ select: UpgradeRequestFindManySelectSchema.optional(),  orderBy: z.union([UpgradeRequestOrderByWithRelationInputObjectSchema, UpgradeRequestOrderByWithRelationInputObjectSchema.array()]).optional(), where: UpgradeRequestWhereInputObjectSchema.optional(), cursor: UpgradeRequestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UpgradeRequestScalarFieldEnumSchema, UpgradeRequestScalarFieldEnumSchema.array()]).optional() }).strict();