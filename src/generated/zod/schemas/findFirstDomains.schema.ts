...
export const DomainsFindFirstSelectSchema: z.ZodType<Prisma.DomainsSelect> = z.object({
...
export const DomainsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    description: z.boolean().optional(),
    jobCount: z.boolean().optional(),
...
export const DomainsFindFirstSchema: z.ZodType<Prisma.DomainsFindFirstArgs> = z.object({ select: DomainsFindFirstSelectSchema.optional(), include: z.lazy(() => DomainsIncludeObjectSchema.optional()), orderBy: z.union([DomainsOrderByWithRelationInputObjectSchema, DomainsOrderByWithRelationInputObjectSchema.array()]).optional(), where: DomainsWhereInputObjectSchema.optional(), cursor: DomainsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DomainsScalarFieldEnumSchema, DomainsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DomainsFindFirstArgs>;

export const DomainsFindFirstZodSchema = z.object({ select: DomainsFindFirstSelectSchema.optional(), include: z.lazy(() => DomainsIncludeObjectSchema.optional()), orderBy: z.union([DomainsOrderByWithRelationInputObjectSchema, DomainsOrderByWithRelationInputObjectSchema.array()]).optional(), where: DomainsWhereInputObjectSchema.optional(), cursor: DomainsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DomainsScalarFieldEnumSchema, DomainsScalarFieldEnumSchema.array()]).optional() }).strict();