...
export const EmailVerificationFindFirstSelectSchema: z.ZodType<Prisma.EmailVerificationSelect> = z.object({
...
export const EmailVerificationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    email: z.boolean().optional(),
    tokenHash: z.boolean().optional(),
