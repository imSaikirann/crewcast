...
export const ApplicationScoreFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ApplicationScoreSelect> = z.object({
...
export const ApplicationScoreFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    applicationId: z.boolean().optional(),
    application: z.boolean().optional(),
    totalScore: z.boolean().optional(),
...
export const ApplicationScoreFindFirstOrThrowSchema: z.ZodType<Prisma.ApplicationScoreFindFirstOrThrowArgs> = z.object({ select: ApplicationScoreFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ApplicationScoreIncludeObjectSchema.optional()), orderBy: z.union([ApplicationScoreOrderByWithRelationInputObjectSchema, ApplicationScoreOrderByWithRelationInputObjectSchema.array()]).optional(), where: ApplicationScoreWhereInputObjectSchema.optional(), cursor: ApplicationScoreWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ApplicationScoreScalarFieldEnumSchema, ApplicationScoreScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ApplicationScoreFindFirstOrThrowArgs>;

export const ApplicationScoreFindFirstOrThrowZodSchema = z.object({ select: ApplicationScoreFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ApplicationScoreIncludeObjectSchema.optional()), orderBy: z.union([ApplicationScoreOrderByWithRelationInputObjectSchema, ApplicationScoreOrderByWithRelationInputObjectSchema.array()]).optional(), where: ApplicationScoreWhereInputObjectSchema.optional(), cursor: ApplicationScoreWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ApplicationScoreScalarFieldEnumSchema, ApplicationScoreScalarFieldEnumSchema.array()]).optional() }).strict();