...
export const FormViewFindFirstSelectSchema: z.ZodType<Prisma.FormViewSelect> = z.object({
...
export const FormViewFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    formId: z.boolean().optional(),
    form: z.boolean().optional(),
    ip: z.boolean().optional(),
...
export const FormViewFindFirstSchema: z.ZodType<Prisma.FormViewFindFirstArgs> = z.object({ select: FormViewFindFirstSelectSchema.optional(), include: z.lazy(() => FormViewIncludeObjectSchema.optional()), orderBy: z.union([FormViewOrderByWithRelationInputObjectSchema, FormViewOrderByWithRelationInputObjectSchema.array()]).optional(), where: FormViewWhereInputObjectSchema.optional(), cursor: FormViewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FormViewScalarFieldEnumSchema, FormViewScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FormViewFindFirstArgs>;

export const FormViewFindFirstZodSchema = z.object({ select: FormViewFindFirstSelectSchema.optional(), include: z.lazy(() => FormViewIncludeObjectSchema.optional()), orderBy: z.union([FormViewOrderByWithRelationInputObjectSchema, FormViewOrderByWithRelationInputObjectSchema.array()]).optional(), where: FormViewWhereInputObjectSchema.optional(), cursor: FormViewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FormViewScalarFieldEnumSchema, FormViewScalarFieldEnumSchema.array()]).optional() }).strict();